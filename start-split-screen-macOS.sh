...
/Applications/Chromium.app/Contents/MacOS/Chromium --app="data:text/html,<html><body><script>window.moveTo(0,0);window.resizeTo(900,1020);window.location='http://localhost:8888';</script></body></html>" &
